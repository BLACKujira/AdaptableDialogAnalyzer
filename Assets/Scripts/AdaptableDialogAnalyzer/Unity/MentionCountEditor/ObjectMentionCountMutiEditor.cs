...
{
    public class ObjectMentionCountMutiEditor : MonoBehaviour
    {
        ...
        ObjectMentionedCountMutiManager mentionedCountManager;
        ...
        {
            ChapterSelectorOMCMChara chapterSelector = window.OpenWindow<ChapterSelectorOMCMChara>(chapterSelectorCharaPrefab);
