...
{
    public class ObjectMentionCountMutiDialogueEditorChara : ObjectMentionCountMutiDialogueEditor
    {
        public Window editorFullPrefab;

        int speakerId;

        public void Initialize(ObjectMentionedCountMutiMatrix mentionedCountMatrix, int speakerId)
        {
