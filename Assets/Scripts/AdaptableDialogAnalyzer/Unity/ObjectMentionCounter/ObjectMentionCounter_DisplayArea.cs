...
{
    public class ObjectMentionCounter_DisplayArea : MonoBehaviour
    {
        public ObjectMentionCounter objectMentionCounter;
        [Header("Components")]
        ...
        private void Update()
        {
            ...
            if (objectMentionCounter.Finished && lastRefresh) return;
            ...
            //完成统计后进行最后一次刷新
            if (objectMentionCounter.Finished) lastRefresh = true;
